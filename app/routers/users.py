...
router = APIRouter(prefix="/users",
                    ...
                    tags=["Users"]) #prefijo para todas las rutas de este router y tag para documentacion
...
@router.get("/{id}",response_model=User, status_code=200) #La solicitud tuvo éxito, El recurso ha sido recuperado y transmitido en el cuerpo del mensaje.
...
@router.get("",response_model=list[User], status_code=200) #La solicitud tuvo éxito, El recurso ha sido recuperado y transmitido en el cuerpo del mensaje.
...
@router.post("",response_model=User, status_code=201) #201 resultado de creacion exitosa
...
@router.put("",response_model=User, status_code=200) #200 resultado exitoso, el recurso ha sido actualizado
...
@router.delete("/{id}",response_model=User, status_code=200) #200 resultado exitoso, el recurso ha sido eliminado
